                ...
                <div class="row justify-content-center g-4">
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="we-value-item">
                            ...
                            <p>
                                We prioritize preventive care by supporting timely vaccinations and continuous health
                                monitoring to ensure pets live healthy and protected lives.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="we-value-item">
                            ...
                            <p>
                                We aim to build trust between veterinary clinics and pet owners by providing accurate,
                                organized, and dependable pet health records.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="we-value-item">
                            ...
                            <p>
                                We value personal privacy and ensure that pet and owner information is kept secure and
                                accessible only to authorized veterinary personnel.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="we-value-item">
                            ...
                            <p>
                                Through a simple scanning system and digital records, we support quick access to pet
                                information, helping veterinarians provide faster and better care.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="we-value-item">
                            ...
                            <p>
                                As a student-developed system, PawCare values the use of technology to improve
                                real-world veterinary services and promote responsible pet ownership.
                            </p>
                        </div>
                    </div>
                </div>
