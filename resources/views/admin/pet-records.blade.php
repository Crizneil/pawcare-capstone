        ...
        <form action="{{ url()->current() }}" method="GET" class="row g-2 align-items-center">
            <div class="col-md-5">
                <div class="input-group">
                    ...
                    <input type="text" name="pet_id" class="form-control border-0 bg-light py-2"
                           placeholder="Scan/Type Pet ID (No Refresh)...">
                </div>
            </div>
            <div class="col-md-5">
                <div class="input-group">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center pe-4">
                                <div class="dropdown">
                                    <button class="btn btn-sm btn-light border rounded-pill px-3 shadow-sm fw-medium" type="button"
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end shadow border-0 rounded-3">
                                        ...
                                        {{-- Delete Action --}}
                                        <li>
                                            <a class="dropdown-item py-2 text-danger" href="#" data-bs-toggle="modal" data-bs-target="#deletePetModal{{ $pet->id }}">
